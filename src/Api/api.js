...
export const shutterStockVideos = (searchQuery) => {
  const SHUTTER_STOCK_ENDPOINT = `https://api.shutterstock.com/v2/videos/search?query=${searchQuery}&page=1&per_page=10`;

  return fetch(SHUTTER_STOCK_ENDPOINT, authParameters)
  .then(response => {
